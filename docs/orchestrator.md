...
boundary. The `src/data_ops_lab/cli_commands/` package now owns 42 parser
...
reconciliation, review, validation, and apply commands, and three Product
materialization, canonical-promotion, and repair commands. `build_parser`
invokes all seven registrars in the original command order, while
