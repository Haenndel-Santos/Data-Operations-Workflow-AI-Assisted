...
boundary. The `src/data_ops_lab/cli_commands/` package now owns 39 parser
...
modeling and human-review commands, and nine Product reference audit,
reconciliation, review, validation, and apply commands. `build_parser` invokes
all six registrars in the original command order, while
